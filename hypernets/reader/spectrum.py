...
class Spectrum(object):
    def __init__(self, data):
        self.headerDef = [("Total Dataset Length", 'H', None),
                          # ("Spectrum Type Information", 'B', read_spectrum_info),  # noqa
                          ("Spectrum Type Information", 'B', None),  # noqa
                          ("Timestamp", 'Q', lambda x: datetime.utcfromtimestamp(int(x/1000))),  # noqa
        ...
        @staticmethod
        def read_spectrum_info(spec_type):
